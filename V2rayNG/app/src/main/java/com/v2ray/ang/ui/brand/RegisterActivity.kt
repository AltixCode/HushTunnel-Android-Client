...
fun RegisterScreen(
    ...
    Scaffold { innerPadding ->
        Column(
            ...
            Text(text = stringResource(R.string.brand_create_account), style = MaterialTheme.typography.headlineMedium)
            Text(
                text = stringResource(R.string.brand_register_subtitle),
            ...
            TextButton(
                ...
                Text(stringResource(R.string.brand_have_account))
            }
        }
    }
